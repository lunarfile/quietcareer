...
const moreItems = [
  { href: '/escape', label: 'Runway', icon: Rocket, desc: 'Financial runway calculator' },
...
export function MobileNav() {
  ...
  return (
    <>
      ...
      {/* Bottom nav */}
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-40 border-t border-surface-border bg-bg-secondary/90 backdrop-blur-lg">
